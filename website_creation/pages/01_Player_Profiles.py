...
if 'Girls' in option:
    elo_df = pd.read_csv(r'website_creation/girl_elo.csv')
    glicko_df = pd.read_csv(r'website_creation/girl_glicko.csv')   
    elo_title = 'Girls Elo Ranking'
    glicko_title = 'Girls Glicko Ranking'
elif 'Boys' in option:
    elo_df = pd.read_csv(r'website_creation/df_boy_elo.csv')
    glicko_df = pd.read_csv(r'website_creation/df_boy_glicko.csv')
    elo_title = 'Boys Elo Ranking'
    glicko_title = 'Boys Glicko Ranking'
elif 'Other' in option:
    elo_df = pd.read_csv(r'website_creation/other_elo.csv')
    glicko_df = pd.read_csv(r'website_creation/other_glicko.csv')
