...
if 'Girls' in option:
    df = pd.read_csv(r'website_creation/complete_girl_df.csv')
elif 'Boys' in option:
    df = pd.read_csv(r'website_creation/complete_boy_df.csv')
elif 'Other' in option:
    df = pd.read_csv(r'website_creation/complete_other_df.csv')
